...
crc32 (uint32_t const crc, uint8_t  const x)    { return _mm_crc32_u8  (crc, x); }

inline VR_FORCE_INLINE uint32_t
crc32 (uint32_t const crc, uint16_t const x)    { return _mm_crc32_u16 (crc, x); }

inline VR_FORCE_INLINE uint32_t
crc32 (uint32_t const crc, uint32_t const x)    { return _mm_crc32_u32 (crc, x); }
/*
 ...
 */
inline VR_FORCE_INLINE uint32_t
crc32 (uint32_t const crc, uint64_t const x)    { return _mm_crc32_u64 (crc, x); }
